...
set OUTPUT_DIR="%PLUGIN_DIR%\..\sample\Assets\Plugins\unityserial"
...
call :build_windows x86_64 " Win64" %errorhandler% || goto :error
call :build_windows_editor x86 "" %errorhandler% || goto :error
call :build_windows_editor x86_64 " Win64" %errorhandler% || goto :error
